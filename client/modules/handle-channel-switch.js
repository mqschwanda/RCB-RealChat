...
let _handleSwitch = (template) => {
  let channel = FlowRouter.getParam('channel'); // get the channel name from the router
  if (channel) { //
    let isDirect = channel.includes('@'); // test to see if the channel is a chat room or direct message
